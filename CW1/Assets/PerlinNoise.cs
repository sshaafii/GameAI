...
public class PerlinNoise 
{
    ...
    //used to generate pseudo random gradient values
   ...
   // so that they will ease towards integral values.
    private static float smoothDistance(float d)
    {
     ...
     public static float PerlinNoise3D(Vector3 point, float frequency)
    {
        point *= frequency;
        ...
        //gets the gradient vectors of each corner. 
       ...
       //calculate dot product
        ...
        //smooth to ensure noise has smooth gradients.
